...
public enum Alliance {
    ...
    WHITE() {
        ...
        //This will choose the white player.
        @Override
    ...
    BLACK() {
        ...
        //Checks if that tile is a pawn promotion tile.
        @Override
        public boolean isPawnPromotionSquare(final int position) {
            return BoardUtils.INSTANCE.EIGHTH_ROW.get(position);
        }

        //The black alliance will choose the black player.
        @Override
        public Player choosePlayerByAlliance(final WhitePlayer whitePlayer,
                                             final BlackPlayer blackPlayer) {
            return blackPlayer;
	...
	//Abstract classes based on what the chess pieces do based on the alliance.
    ...
    //Coordinates based on where the chess pieces could move.
